...
\begin{frame}
	...
	$\vec{a} = (2, 5)$ $\vec{b} = (-2, 3)$ Orthogonale Zerlegung von $\vec{a}$ in Richtung von $\vec{b}$
	1. Bilden des Einheitsvektors \\
	$\vec{e} = \frac{\vec{b}}{\lvert \vec{b} \rvert} = \frac{1}{\sqrt{13}} \cdot (-2, 3)$\\
	2. Bilden von $\vec{a}_{\parallel}$
